...
<div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
      ...
      <![endif]--><div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:36px;font-weight:600;line-height:36px;text-align:center;">Welcome to Peersity!</div><!--[if mso | IE]>
      </td></tr></table>
...
<p>Wowwee! Thanks for registering an account with Peersity! You're the coolest person in all the land (and I've met a lot of really cool people).</p>
<p>Before we get started, we'll need to verify your email.</p>

<p>If the below button does not work, try copy and pasting the following url in your browser: <pre> ${link} </pre></p>
      ...
      Peersity was originally known as SocialIIIT, but was dropped after it was too tiresome to teach people how to pronounce it correctly/make people understand the pun.
